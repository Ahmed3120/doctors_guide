                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="{{route('mainDashboard')}}" >
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">الصفحة الرئيسية</span>
                            </div>
                    ...
                    <!-- menu item addDoctor-->
                    <li>
                        <a href="{{route('docpationts', Auth::user()->id)}}"><i class="ti-user"></i><span class="right-nav-text">المراجعين
                            </span></a>
                    </li>
                    <!-- menu item mailbox-->
                    <li>
                        <a href="{{route('docpationt', Auth::user()->id)}}"><i class="ti-user"></i><span class="right-nav-text">طلبات المراجعة</span></a>
                    </li>

                    <li>
                        <a href="{{route('docedit', Auth::user()->id)}}"><i class="ti-user"></i><span class="right-nav-text">اعدادات الحساب</span></a>
                    </li>
