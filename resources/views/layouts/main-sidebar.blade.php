        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu item addDoctor-->
                    <li>
                        <a href="{{route('addDoctor')}}"><i class="ti-user"></i><span class="right-nav-text">addDoctor
                            </span></a>
                    </li>
                    <!-- menu item mailbox-->
                    <li>
                        <a href="{{route('showDoctor')}}"><i class="ti-eye"></i><span class="right-nav-text">Show All Doctors</span></a>
                    </li>
